use utf8;
package IntelliShip::ArrsClass::Result::DhlShipmentInfo;
...
IntelliShip::ArrsClass::Result::DhlShipmentInfo
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:CYxhejQTOlxPnPLPy+uogg
