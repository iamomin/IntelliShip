package IntelliShip::Model::MyArrs;
...
__PACKAGE__->config(
    ...
    connect_info => {
           dsn => 'dbi:Pg:dbname=arrs;host=' . IntelliShip::MyConfig->getDatabaseHost . ';port=5432;',
           user     => 'webuser',
           password => 'Byt#Yu2e',
...
IntelliShip::Model::MyArrs - Catalyst DBIC Schema Model
...
L<Catalyst::Model::DBIC::Schema> Model using schema L<IntelliShip::ArrsClass>
