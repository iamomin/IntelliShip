...
my $CUSTOMER_CONTACT_RULES = [
	...
	{ name => 'Require', value => 'reqcustref2' , type => 'CHECKBOX', datatypeid => 1 , ownertype => ['CUSTOMER']},
	{ name => 'Require', value => 'reqcustref3' , type => 'CHECKBOX', datatypeid => 1 , ownertype => ['CUSTOMER']},
	{ name => 'Require Department', value => 'reqdepartment' , type => 'CHECKBOX', datatypeid => 1 , ownertype => ['CUSTOMER']},
	{ name => 'Require', value => 'reqextid' , type => 'CHECKBOX', datatypeid => 1 , ownertype => ['CUSTOMER']},
	...
	{ name => 'Return Capability' , value => 'returncapability' , type => 'SELECT', datatypeid => 1 , ownertype => ['CUSTOMER', 'CONTACT']},
	{ name => 'Login Level' , value => 'loginlevel' , type => 'SELECT', datatypeid => 1 , ownertype => ['CUSTOMER', 'CONTACT']},
	{ name => 'Dropship Capability' , value => 'dropshipcapability' , type => 'SELECT', datatypeid => 1 , ownertype => ['CUSTOMER', 'CONTACT']},
	{ name => 'Display Quote Markup' , value => 'quotemarkup' , type => 'SELECT', datatypeid => 1 , ownertype => ['CUSTOMER', 'CONTACT']},
	{ name => 'Quote Markup Default' , value => 'quotemarkupdefault' , type => 'SELECT', datatypeid => 1 , ownertype => ['CUSTOMER', 'CONTACT']},
	...
	{ name => 'PO Auth Type' , value => 'poauthtype' , type => 'SELECT', datatypeid => 1 , ownertype => ['CUSTOMER', 'CONTACT']},
	{ name => 'Company Type' , value => 'companytype' , type => 'SELECT', datatypeid => 1 , ownertype => ['CUSTOMER']},
	{ name => 'Print Packing List' , value => 'defaultpackinglist' , type => 'SELECT', datatypeid => 1 , ownertype => ['CUSTOMER', 'CONTACT']},
	{ name => 'Packing List' , value => 'packinglist' , type => 'SELECT', datatypeid => 1 , ownertype => ['CUSTOMER', 'CONTACT']},
	{ name => 'Live Product TAB' , value => 'liveproduct' , type => 'SELECT', datatypeid => 2 , ownertype => ['CUSTOMER']},
	{ name => 'Freight Charge Editablity' , value => 'fceditability' , type => 'SELECT', datatypeid => 1 , ownertype => ['CUSTOMER']},
	{ name => 'Label Stub' , value => 'labelstub' , type => 'SELECT', datatypeid => 2 , ownertype => ['CUSTOMER']},
	{ name => 'My Orders' , value => 'myorders' , type => 'CHECKBOX', datatypeid => 1 , ownertype => ['CONTACT']},
	{ name => 'Text Status' , value => 'indicatortype' , type => 'SELECT', datatypeid => 1 , ownertype => ['CONTACT']},
